    ...
    public function approve($modelType, $model, Request $request)
    {
        ...
        if ($nextApproval) {
            $notificationMap = [
                ...
                ApprovalModels::ACCOUNTING_BOOK_BALANCE_REPORT->name => RequestBookBalanceReportForApprovalNotification::class,
            ];
            ...
            $notificationMap = [
                ...
                ApprovalModels::ACCOUNTING_BOOK_BALANCE_REPORT->name => RequestBookBalanceReportForDeniedNotification::class,
            ];
            if (isset($notificationMap[$modelType])) {
