...
use App\Http\Resources\LiquidationRequestCollection;
...
class LiquidationController extends Controller
{
    public function index(LiquidationFilterRequest $request)
    {
        ...
        $purchaseOrders = PaymentRequest::liquidationRequest()
        ...
        return (new LiquidationRequestCollection($purchaseOrders))->additional([
            'success' => true,
