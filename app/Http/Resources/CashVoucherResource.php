    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'step_approval' => [
                ...
                'disbursement_voucher' => new ApprovalAttributeResource(['approvals' => $this->journalEntry->voucher()->first()->approvals ?? []]),
                'cash_voucher' => new ApprovalAttributeResource(['approvals' => $this->approvals ?? []]),
            ]
        ];
    }
}
