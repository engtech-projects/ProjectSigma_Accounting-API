...
class TransactionFlowModelSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $flows = [
            ...
            ['name' => 'Create Journal Entry', 'unique_name' => 'create_journal_entry', 'category' => 'journal_entry', 'is_assignable' => true, 'priority' => 6],
            ['name' => 'Generate Disbursement Voucher', 'unique_name' => 'generate_disbursement_voucher', 'category' => 'disbursement_voucher', 'is_assignable' => true, 'priority' => 7],
            ['name' => 'Check and Review Disbursement Voucher', 'unique_name' => 'check_and_review_disbursement_voucher', 'category' => 'disbursement_voucher', 'is_assignable' => true, 'priority' => 8],
            ['name' => 'Disbursement Voucher Approval', 'unique_name' => 'disbursement_voucher_approval', 'category' => 'disbursement_voucher', 'is_assignable' => false, 'priority' => 9],
            ['name' => 'Generate Cash Voucher', 'unique_name' => 'generate_cash_voucher', 'category' => 'cash_voucher', 'is_assignable' => true, 'priority' => 10],
            ['name' => 'Cash Voucher Approvals', 'unique_name' => 'cash_voucher_approvals', 'category' => 'cash_voucher', 'is_assignable' => false, 'priority' => 11],
            ['name' => 'Payments', 'unique_name' => 'payments', 'category' => 'payments', 'is_assignable' => true, 'priority' => 12],
        ];
